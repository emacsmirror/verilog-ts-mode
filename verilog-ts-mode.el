...
(defconst verilog-ts-keywords
  '("accept_on" "alias" "and" "assert" "assign" "assume" "before" "bind"
    "binsof" "break" "case" "checker" "class" "class" "clocking" "config"
    "const" "constraint" "cover" "covergroup" "coverpoint" "cross" "default"
    "defparam" "disable" "do" "else" "endcase" "endchecker" "endclass"
    "endclocking" "endconfig" "endfunction" "endgenerate" "endgroup"
    "endinterface" "endmodule" "endpackage" "endprogram" "endproperty"
    "endsequence" "endtask" "enum" "eventually" "export" "extends" "extern"
    "final" "first_match" "for" "force" "foreach" "forever" "fork" "forkjoin"
    "function" "generate" "genvar" "if" "iff" "illegal_bins" "implements"
    "implies" "import" "initial" "inside" "interconnect" "interface" "intersect"
    "join" "join_any" "join_none" "let" "local" "localparam" "matches" "modport"
    "new" "nexttime" "null" "option" "or" "package" "packed" "parameter"
    "program" "property" "pure" "randcase" "randomize" "reject_on" "release"
    "repeat" "return" "s_always" "s_eventually" "s_nexttime" "s_until"
    "s_until_with" "sequence" "showcancelled" "soft" "solve" "struct" "super"
    "sync_accept_on" "sync_reject_on" "tagged" "task" "throughout"
    "timeprecision" "timeunit" "type" "typedef" "union" "unique" "until"
    "until_with" "virtual" "wait" "while" "with"
